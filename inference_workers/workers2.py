...
from inference_workers.rabbitmq_subscriber import RabbitMQSubsriber
...
def do_work(ch, delivery_tag, properties, body, executor, transcription_srv, redis_client):
